...
describe('BillingService', () => {
  ...
  describe('createCheckoutSession', () => {
    ...
    it('crea checkout session e restituisce URL se Stripe è abilitato', async () => {
      ...
      (mockPrisma.tenant.update as jest.Mock).mockResolvedValue({ ...tenant, stripeCustomerId: 'cus_test123' });
      (mockStripeService.createCheckoutSession as jest.Mock).mockResolvedValue('https://checkout.stripe.com/test');

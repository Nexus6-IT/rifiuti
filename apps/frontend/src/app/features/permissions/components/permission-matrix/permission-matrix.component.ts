      ...
      >
        ...
        <ng-template pTemplate="body" let-permission>
          ...
          >
            ...
            <td>
              <p-tag [value]="permission.action" [severity]="getActionSeverity(permission.action)"></p-tag>
            </td>

            <td>
              <p-tag [value]="permission.scope" [severity]="getScopeSeverity(permission.scope)"></p-tag>
            </td>
...
export class PermissionMatrixComponent {
  ...
  parsedPermissions = signal<Array<{
  ...
  filteredPermissions = computed(() => {
    ...
    return this.parsedPermissions().filter((p) =>

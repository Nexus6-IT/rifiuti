...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <header class="page-header">
        <div class="page-header__titles">
          ...
          <p class="page-subtitle">
            Gestisci il piano WasteFlow del tuo tenant
          </p>
        </div>
      </header>
      ...
      <!-- Caricamento -->
      @if (loading()) {
        <div class="center-spinner" role="status" aria-live="polite" aria-label="Caricamento stato abbonamento">
      ...
      @if (!loading() && billingStatus()) {
          ...
          <div class="alert alert--danger mb-4" role="alert">
            ...
            <div class="alert__body">
              ...
              <p class="alert__text">
                ...
                (creazione FIR, anagrafiche, movimenti) sono temporaneamente bloccate.
                Aggiorna il metodo di pagamento per ripristinare l'accesso.
              </p>
        ...
        @if (billingStatus()!.status === 'EXPIRED') {
          <div class="alert alert--warning mb-4" role="alert">
            ...
            <div class="alert__body">
              ...
              <p class="alert__text">
                Il tuo abbonamento è scaduto. Rinnova il piano per continuare a usare
                tutte le funzionalità operative di WasteFlow.
              </p>
            </div>
          </div>
        }
        ...
        @if (testMode()) {
          <div class="alert alert--info mb-4" role="note">
            ...
            <div class="alert__body">
              ...
              <p class="alert__text">
                Il sistema di pagamento Stripe non è ancora attivo su questo ambiente.
                I pulsanti di acquisto sono visibili ma non reindirizzano a Stripe.
                Configura <code>STRIPE_SECRET_KEY</code> nel file <code>.env</code> del backend per attivare i pagamenti.
              </p>
            </div>
          </div>
        }
        ...
        <section class="current-plan-card mb-5" aria-label="Piano corrente">
          <div class="current-plan-card__header">
            ...
            <span
              class="status-badge"
              [class.status-badge--active]="billingStatus()!.status === 'ACTIVE' || billingStatus()!.status === 'TRIAL'"
          ...
          <dl class="current-plan-card__stats">
            <div class="stat-item">
              ...
              <dd class="stat-item__value">
                {{ billingStatus()!.firLimitPerMonth === 0 ? 'Illimitati' : billingStatus()!.firLimitPerMonth }}
              </dd>
            </div>
            <div class="stat-item">
              <dt class="stat-item__label">Utenti totali</dt>
              <dd class="stat-item__value">
                {{ billingStatus()!.userLimitTotal === 0 ? 'Illimitati' : billingStatus()!.userLimitTotal }}
              </dd>
            </div>
            ...
            @for (piano of piani; track piano.tier) {
              ...
              >
                ...
                @if (billingStatus()!.tier === piano.tier) {
                  <div class="piano-card__current-badge" aria-label="Piano attivo">Piano attivo</div>
                }
                ...
                <div class="piano-card__footer">
                  @if (billingStatus()!.tier === piano.tier) {
                    ...
                    <button
                      ...
                      [class]="piano.evidenziato ? 'p-button-primary w-full' : 'p-button-outlined w-full'"
                      [loading]="checkoutLoading() === piano.tier"
                      [disabled]="billingStatus()!.status === 'SUSPENDED'"
                      (click)="avviaCheckout(piano.tier)"
                      [attr.aria-label]="'Esegui upgrade al piano ' + piano.nome + ' a ' + piano.prezzo + ' / ' + piano.periodicita"
                    ></button>
                  }
                </div>
              </article>
        ...
        <footer class="billing-footer mt-5">
          <p class="billing-footer__text">
            ...
            <a href="https://stripe.com" target="_blank" rel="noopener noreferrer" class="billing-footer__link">Stripe</a>
            in modo sicuro. Puoi disdire in qualsiasi momento dal Billing Portal.
            Per assistenza scrivi a
            <a href="mailto:supporto&#64;wasteflow.it" class="billing-footer__link">supporto&#64;wasteflow.it</a>.
          </p>
        </footer>
      }
    </div>
  ...
  styles: [`
    ...
    @media (max-width: 767.98px) {
      ...
      .current-plan-card__header { flex-direction: column; align-items: flex-start; }
    }
  `],
})

      ...
      <main class="denied-container" role="main">
        ...
        <div class="denied-header">
          ...
          <p class="denied-subtitle">
            Non hai i permessi necessari per visualizzare questa pagina. Nessun problema: qui sotto
            trovi cosa puoi fare.
          </p>
        </div>
        ...
        <section class="surface-card denied-card" aria-label="Dettagli del permesso richiesto">
          ...
          <div class="info-section" *ngIf="showUserPermissions">
            ...
            <div class="permissions-list">
              <div *ngFor="let permission of getUserPermissions()" class="permission-item">
                <i class="pi pi-check-circle" aria-hidden="true"></i>
                <code>{{ permission }}</code>
              </div>
              <div *ngIf="getUserPermissions().length === 0" class="no-permissions">

      ...
      <p-menubar [model]="menuItems" styleClass="layout-menubar">
        ...
        <ng-template pTemplate="end">
          <div class="flex align-items-center gap-2">
            <p-avatar [label]="getUserInitials()" shape="circle" styleClass="mr-2" />
      ...
      <div class="layout-sidebar">
        <div class="sidebar-content">
          <nav class="nav-menu">
            ...
            <a routerLink="/fir" routerLinkActive="active" class="nav-item">
              <i class="pi pi-file"></i>
              <span>FIR</span>
            </a>
            <a routerLink="/cer" routerLinkActive="active" class="nav-item">
              <i class="pi pi-tags"></i>
              <span>Catalogo CER</span>
            </a>

            <div class="nav-section-title">Anagrafiche</div>
            <a routerLink="/produttori" routerLinkActive="active" class="nav-item nav-item-indent">
            ...
            <a routerLink="/destinatari" routerLinkActive="active" class="nav-item nav-item-indent">

      ...
      <header class="page-header">
        <div class="page-header__titles">
          ...
          <p class="page-subtitle">
            Contratti produttore ↔ controparte: trasporto, smaltimento e servizi
          </p>
        </div>
        <div class="page-actions">
          <p-button
            ...
            ariaLabel="Crea un nuovo contratto"
          />
        </div>
      </header>
        ...
        <div class="grid formgrid">
          ...
          <div class="field col-12 md:col-6">
            ...
            <input
              ...
              placeholder="UUID registro produttore"
              class="w-full"
            />
          </div>
          <div class="field col-12 md:col-6">
            ...
            <input
              id="c-counterparty"
              pInputText
              [(ngModel)]="form.counterpartyId"
              placeholder="UUID registro controparte"
              class="w-full"
            />
          </div>
          <div class="field col-12 md:col-6">
          ...
          <div class="field col-12">
            ...
            <p-chips
              inputId="c-cer"
              [(ngModel)]="form.cerCodes"
              placeholder="Aggiungi CER e premi Invio"
              styleClass="w-full"
            ></p-chips>
          ...
          <div class="field col-12 md:col-6" *ngIf="form.autoRenew">
            ...
            <p-inputNumber
              inputId="c-notice"
              [(ngModel)]="form.renewalNoticeDays"
              [min]="0"
              styleClass="w-full"
              inputStyleClass="w-full"
            ></p-inputNumber>

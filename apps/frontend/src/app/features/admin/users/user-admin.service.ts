...
export class UserAdminService {
  ...
  setCompanyLimit(id: string, companyLimit: number): Observable<AdminUser> {
    return this.http.patch<AdminUser>(`${this.API_URL}/users/${id}/company-limit`, { companyLimit })
  }
  ...
  impersonate(userId: string): Observable<ImpersonateResult> {
    return this.http.post<ImpersonateResult>(`${this.API_URL}/users/${userId}/impersonate`, {})
  }
}

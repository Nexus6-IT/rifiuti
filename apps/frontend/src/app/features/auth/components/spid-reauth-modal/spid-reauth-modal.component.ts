    ...
    >
      <ng-template pTemplate="header">
        <div class="dialog-header">
          <i
            class="pi pi-shield"
            style="font-size: 1.5rem; color: var(--brand-primary); margin-right: 0.5rem;"
            aria-hidden="true"
          ></i>
      ...
      <div class="reauth-content">
        <p-message
          severity="warn"
          [text]="
            'Questa operazione richiede una nuova autenticazione SPID/CIE per motivi di sicurezza.'
          "
          [closable]="false"
        ></p-message>
        ...
        <div class="security-notice">
          <p>
            ...
            Per la tua sicurezza, le operazioni critiche richiedono una riautenticazione se sono
            trascorsi più di <strong>15 minuti</strong> dall'ultimo accesso SPID.
          </p>
        </div>
...
export class SpidReauthModalComponent implements OnInit {
   ...
   */
  show(error: HttpErrorResponse, retryCallback: () => void, cancelCallback?: () => void): void {
  ...
  onReauthenticate(): void {
    ...
    window.location.href =
      '/api/v1/auth/spid/login?returnUrl=' + encodeURIComponent(window.location.pathname)
  }

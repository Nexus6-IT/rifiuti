    ...
    >
      ...
      <ng-container *ngIf="variant === 'card'">
        <div *ngFor="let _ of repeatArray" class="skeleton-card">
          <div
            class="skeleton skeleton-rectangle"
            style="width: 100%; height: 120px; margin-bottom: 1rem;"
          ></div>
          <div
            class="skeleton skeleton-text"
            style="width: 80%; height: 20px; margin-bottom: 0.5rem;"
          ></div>
          <div
            class="skeleton skeleton-text"
            style="width: 60%; height: 16px; margin-bottom: 0.5rem;"
          ></div>
      ...
      <ng-container *ngIf="variant === 'list'">
        <div *ngFor="let _ of rowsArray" class="skeleton-list-item">
          ...
          <div style="flex: 1;">
            <div
              class="skeleton skeleton-text"
              style="width: 70%; height: 16px; margin-bottom: 0.5rem;"
            ></div>
      ...
      <ng-container *ngIf="variant === 'stats'">
        <div *ngFor="let _ of repeatArray" class="skeleton-stats-card">
          <div style="flex: 1;">
            <div
              class="skeleton skeleton-text"
              style="width: 60%; height: 14px; margin-bottom: 0.5rem;"
            ></div>

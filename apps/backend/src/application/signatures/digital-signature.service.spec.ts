...
describe('DigitalSignatureService (Integration)', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [DigitalSignatureService, { provide: LoggerService, useValue: mockLogger }],
    }).compile()
  ...
  describe('Signature Verification', () => {
    it('should verify valid signature', async () => {
      ...
      const isValid = await service.verify(documentHash, signature, keyPair.publicKey)
    ...
    it('should reject tampered signature', async () => {
      ...
      const isValid = await service.verify(documentHash, tamperedSignature, keyPair.publicKey)
...
-----END PUBLIC KEY-----`
  ...
  describe('Complete Signature Workflow', () => {
    ...
    it('should fail verification if document is modified', async () => {
      ...
      const isValid = await service.verify(modifiedHash, signature, keyPair.publicKey)
  ...
  describe('Error Handling', () => {
    ...
    it('should handle malformed signature', async () => {
      ...
      const isValid = await service.verify(documentHash, malformedSignature, keyPair.publicKey)

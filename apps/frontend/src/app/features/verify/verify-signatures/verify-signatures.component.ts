  ...
  template: `
    <div class="verify-signatures-container">
      ...
      <div class="header text-center mb-5">
        ...
        <p class="verify-subtitle">Sistema pubblico di verifica per conformità D.M. 59/2023</p>
      </div>
        ...
        <p-card styleClass="mb-4">
          ...
          <div class="grid">
            <div class="col-12 md:col-6">
              ...
              <p class="text-xl font-semibold">{{ verificationResult()!.signatureCount }} / 3</p>
            </div>
            <div class="col-12 md:col-6">
          ...
          <p-message severity="info" styleClass="w-full">
            <ng-template pTemplate>
              <div class="flex flex-column">
                ...
                <span class="text-sm">
                  Questa verifica è conforme al Decreto Ministeriale 59/2023 sul sistema RENTRI. Le
                  firme digitali hanno valore legale e sono verificate utilizzando ECDSA-SHA256 con
                  timestamp RFC 3161 per garantire non-ripudio e integrità del documento.
                </span>
              </div>
            </ng-template>
          </p-message>
...
export class VerifySignaturesComponent implements OnInit {
  ...
  private async verifySignatures(firId: string): Promise<void> {
    ...
    try {
      const result = await this.signatureService.verifySignatures(firId).toPromise()
      ...
      this.error.set(err.error?.message || err.message || 'Errore durante verifica firme digitali')
    } finally {
      this.isLoading.set(false)
    }
  }
